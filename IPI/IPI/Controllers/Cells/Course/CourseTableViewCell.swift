...
class CourseTableViewCell: UITableViewCell, UITextFieldDelegate {
    ...
    func fill_CELL_08() {
        ...
        lbl_Aud1.text = IPI_COURSE.PAGE_08.AUDIO_1
        lbl_Aud2.text = IPI_COURSE.PAGE_08.AUDIO_2
        lbl_Aud3.text = IPI_COURSE.PAGE_08.AUDIO_3
        lbl_Aud4.text = IPI_COURSE.PAGE_08.AUDIO_4
    }
    ...
    func fill_CELL_09() {
        ...
        lbl_title.text = IPI_COURSE.PAGE_09.title
        lbl_Aud1.text = IPI_COURSE.PAGE_09.AUDIO_1
    ...
    func fill_CELL_10() {
        content_tilte?.topline()
        lbl_title.text = IPI_COURSE.PAGE_10.title
